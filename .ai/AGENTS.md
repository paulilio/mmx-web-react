...
## Skills (.ai/skills/)
Referências técnicas canônicas compartilhadas via aiws-castler. Ler quando o contexto for relevante:
- `.ai/skills/neon-postgres.md` — guia Neon Serverless Postgres (drivers, branching, auth, CLI, APIs)
