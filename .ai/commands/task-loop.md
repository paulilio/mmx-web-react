...
5. **Record** — Criar run em .aiws/runs/ usando template .aiws/templates/run.md
6. **Finalize** — Mover task para .aiws/tasks/done/. Se houve aprendizado, criar artefato em .aiws/knowledge/
