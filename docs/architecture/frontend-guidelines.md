...
- Aliases de compatibilidade de naming devem ficar em `hooks/compat/`, nao na raiz de `hooks/`.
- Para manutencao de configuracoes (import/export/clear), usar `use-settings-maintenance.ts`; nao acessar storage/localStorage diretamente na pagina.
