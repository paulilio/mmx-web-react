...
## Description
Prompts para geracao dos arquivos customizados do projeto em `.aiws/references/aiws-custom/`.
...
Gere o arquivo .aiws/references/aiws-custom/custom-workspace-guide.md — guia de uso do workspace
...
Gere o arquivo .aiws/references/aiws-custom/custom-gpt-prompt.md — system prompt para um chat
...
Gere o arquivo .aiws/references/aiws-custom/custom-v0-instructions.md — instrucoes para o v0 (Vercel)
